...
export default function Services() {
  ...
  return (
    <section id="service" className="relative bg-[#0b0f19] text-white py-28 px-6 overflow-hidden">
      ...
      <div className="absolute top bg-purple-600 opacity-20 blur-[150px] rounded-full"></div>
      <div className="absolute bg-cyan-500 opacity-20 blur-[150px] rounded-full"></div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-24 relative">
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight">
            What I <span className="text-transparent bg-clip-text bg-gray-600 from-purple-400 to-cyan-400">Offer</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {services.map((service, index) => (
            <div
              key={index}
              className="group relative  rounded-3xl bg-gray-900 from-purple-500/40 via-cyan-400/40 to-purple-500/40 hover:from-purple-500 hover:to-cyan-500 transition duration-700"
            >
              {/* Inner Card */}
              <div className="relative h-full bg-[#111827]/80 backdrop-blur-2xl rounded-3xl p-10 transition duration-500 group-hover:-translate-y-4">
                ...
                {/* Icon */}
                <div className="mb-8 inline-flex items-center justify-center w-14 h-14 rounded-xl bg-gray-900 from-purple-500 to-cyan-500 text-white shadow-lg">
                  {service.icon}
                </div>
                ...
                {/* Hover Line */}
                <div className="absolute bottom-8 left-10 w-0  bg-gray-800 from-purple-400 to-cyan-400 group-hover:w-20 transition-all duration-500"></div>
              </div>
            </div>
          ))}
        </div>
