...
import Headerimage from '../img/inam-2.jpg'
const Hero = () => {
  return (
    <section id="home" className="min-h-screen flex flex-col md:flex-row items-center justify-center bg-gray-700 from-gray-900 via-gray-900  to-gray-950 text-white px-6">
